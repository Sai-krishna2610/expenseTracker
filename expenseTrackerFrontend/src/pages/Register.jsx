...
function Register() {
    ...
    return (
        <div className="relative flex justify-center items-center h-screen w-full bg-gradient-to-br from-[#0F172A] to-[#1E293B] overflow-hidden select-none">
            ...
            <div className="z-10 p-6 rounded shadow-md w-96 login-card-glass text-slate-200">
                <h2 className="text-2xl font-bold text-center mb-6 text-[#F8FAFC]">
                    Register
                </h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                    <input
                        ...
                        className="border p-2 rounded-md input-glass"
                        required
                    />
                    ...
                    <div className="relative">
                        <input
                            ...
                            value={form.password}
                            onChange={handleChange}
                            className="w-full border p-2 pr-10 rounded-md input-glass input-glass-indigo"
                            required
                        />
                    ...
                    {isLoading && (
                        <p className="text-emerald-400 text-sm font-medium animate-pulse-emerald">
                            Loading...
                        </p>
                    )}
                    ...
                    <button
                        type="submit"
                        className="text-white p-2 rounded transition-all btn-emerald-gradient cursor-pointer"
                    >
                        Register
                    </button>
                </form>
                ...
                <div className="flex items-center my-5">
                    ...
                    <span className="mx-3 text-slate-400 text-sm">
                        OR
                    </span>
                    <div className="flex-grow border-t border-slate-700"></div>
                </div>
